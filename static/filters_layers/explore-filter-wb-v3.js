...
function onLaunchWB(){
	...
	$.ajax({
		...
		var workBookJson=[];
		for(var key in data){
			if(data[key]['result'] == "No Result Found"){
			...
			for(var j = 0;j<data[key]['result'].length; j++){
				...
				arr['distance'] = data[key]['result'][j].distance;
...
function workbookmap(){
	...
	if(workbookKeys.length>0){
		...
		for(var s=0;s<workbookKeys.length;s++){
			...
			var keyname2=name;
			if(name.length > 15){
				keyname1 = keyname2.substring(0, 15);
				keyname2 = keyname1+" ..."
			}
			...
			for(var i=0;i<jsonData.length;i++){
				if(jsonData[i].latitude){
					if(jsonData[i].longitude){
						...
						var html ='';
						html +='<div class="tab-content" style="width:250px;">';
						//village / town
						for(var j=0; j<places.length; j++){
							if(jsonData[i][places[j]]){
								html += '<div class="textWrap"><strong>' + places[j] + '</strong>: ' + jsonData[i][places[j]] + '</div>';
						...
						//villagecode
						if(jsonData[i]['id_4']){
							html += '<div class="textWrap"><strong> Village Code </strong>: ' + jsonData[i]['id_4'] + '</div>';
						}
						//distance
						if(jsonData[i]['distance']){
							html += '<div class="textWrap"><strong> Distance From Branch </strong>: ' + jsonData[i]['distance'].toFixed(2) + ' Km</div>';
						}else if(originLatLongArrBKP.length>0){
							html += '<div class="textWrap"><strong> Distance From Branch </strong>: </div>';
						}
						
						if(originLatLongArrBKP.length>0){
							html += '<div class="textWrap"><strong> No of Customers </strong>: </div>';
						}
						html +='</div>';
						...
						if(originLatLongArrBKP.length == 0){
							...
							html +='<div class="tab-content" style="display:none" id="tbl_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'">';
							html +='<div class="textWrap"><div style="width:50px;display:inline-block;vertical-align: super;"><strong>Radius :</strong></div>  <div style="width:160px;display:inline-block;"><select class="custom_selectbox popup-selectbox" style="width:150px;" id="wb_radius_id_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" >'+
							...
							html +='<div class="textWrap"><div style="width:50px;display:inline-block;vertical-align: super;"><strong>Data &nbsp;&nbsp;&nbsp;&nbsp;:</strong></div>  <div style="width:160px;display:inline-block;"><select id="wb_data_id1_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" class="custom_selectbox popup-selectbox" style="width:150px;">'+dataContent+'</select></div></div>';
							html +='</div>';
							html +='<div class="tab-content">';
							html +='<div class="textWrap"><div style="width:50px;display:inline-block;vertical-align: super;"><strong>Data &nbsp;&nbsp;&nbsp;&nbsp;:</strong></div>  <div style="width:160px;display:inline-block;"><select id="wb_data_id2_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" class="custom_selectbox popup-selectbox" style="width:150px;">'+dataContent+'</select></div></div>';
							html +='</div>';
							html +='<div class="tab-content">';
							html +='<div class="textWrap"><div style="width:50px;display:inline-block;vertical-align: super;"><strong>Data &nbsp;&nbsp;&nbsp;&nbsp;:</strong></div>  <div style="width:160px;display:inline-block;"><select id="wb_data_id3_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" class="custom_selectbox popup-selectbox" style="width:150px;">'+dataContent+'</select></div></div>';
							html +='</div>';
							html +='<div class="tab-content">';
							html +='<div class="textWrap"><div style="width:50px;display:inline-block;vertical-align: super;"><strong>Data &nbsp;&nbsp;&nbsp;&nbsp;:</strong></div>  <div style="width:160px;display:inline-block;"><select id="wb_data_id4_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" class="custom_selectbox popup-selectbox" style="width:150px;">'+dataContent+'</select></div></div>';
							html +='</div>';
							html +='<div class="tab-content">';
							html +='<div class="textWrap" style="text-align: center;"><button class="map-save-tab-leaflet-apply" style="display:inline-block;width:120px;" onclick="onLaunchWB();">Launch Workbook</button></div>';
							html +='</div>';
						...
						/*html +='<div class="tab-content">'+
							...
							'<table style="display:none" id="tbl_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'">'+
							  //'<tr>'+
							    //'<td>Origin</td>'+
							    //'<td> : <input type="checkbox" id="idorigin_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" onclick="originClick('+lat+','+lng+','+jsonData[i].id_4+');"></td>'+
							  //'</tr>'+
							  '<tr>'+
							    '<td>Radius</td>'+
							    '<td> : <select class="custom_selectbox" id="wb_radius_id_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" style="width:150px;">'+
							      '<option value="5km">5km</option>'+
							      '<option value="10km">10km</option>'+
							      '<option value="15km">15km</option>'+
							      '<option value="20km">20km</option>'+
							  ...
							  '<tr>'+
							    '<td>Data</td>'+
							    '<td> : <select id="wb_data_id1_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" style="width:150px;" class="custom_selectbox">'+dataContent+'<select></td>'+
							  '</tr>'+
							  '<tr>'+
							    '<td>Data</td>'+
							    '<td> : <select id="wb_data_id2_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" style="width:150px;" class="custom_selectbox">'+dataContent+'<select></td>'+
							  '</tr>'+
							  '<tr>'+
							    '<td>Data</td>'+
							    '<td> : <select id="wb_data_id3_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" style="width:150px;" class="custom_selectbox">'+dataContent+'<select></td>'+
							  '</tr>'+
							  '<tr>'+
							    '<td>Data</td>'+
							    '<td> : <select id="wb_data_id4_'+lat.replace('.','_')+"_"+lng.replace('.','_')+'" style="width:150px;" class="custom_selectbox">'+dataContent+'<select></td>'+
							  '</tr><br>'+
							  '<tr>'+
							    '<td></td>'+
							    '<td><button class="map-save-tab-leaflet-apply" style="display:inline-block;width:120px;" onclick="onLaunchWB();">Launch Workbook</button></td>'+
							  '</tr>'+
							'</table>'+
							'</div>'+
							'</div>';*/
						...
						//$('.custom_selectbox').selectBoxIt();
						//$("#wb_radius_id_"+lat.replace('.','_')+"_"+lng.replace('.','_')+"").data("selectBox-selectBoxIt").add();
						/*$("#wb_data_id1_"+lat.replace('.','_')+"_"+lng.replace('.','_')).data("selectBox-selectBoxIt").add();
						$("#wb_data_id2_"+lat.replace('.','_')+"_"+lng.replace('.','_')).data("selectBox-selectBoxIt").add();
						$("#wb_data_id3_"+lat.replace('.','_')+"_"+lng.replace('.','_')).data("selectBox-selectBoxIt").add();
						$("#wb_data_id4_"+lat.replace('.','_')+"_"+lng.replace('.','_')).data("selectBox-selectBoxIt").add();*/
						//$("#wb_radius_id_"+lat.replace('.','_')+"_"+lng.replace('.','_')+"").selectBoxIt();
					}
				}
			}
