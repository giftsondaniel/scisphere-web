...
function _rebuildHexLegend(countOrProportion, questionName, responseNames)
{
   ...
   /* var options = {
    ...
    $('#legends-container').bootstrapPaginator(options);*/
    //added
...
function rebuildLegend(questionName, questionColorMap)
{
    ...
    legendTitle = $('<h3></h3>');
    legendElement.css('visibility', 'hidden');
    ...
    legendUl = $('<ul></ul>').addClass('nav nav-pills nav-stacked pagination1');
