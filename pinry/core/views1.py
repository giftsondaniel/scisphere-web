...
def post_image_pins(request):
    ...
    if request.is_ajax():
       ...
       try:
          ...
          con = psycopg2.connect(host='107.170.87.131',user='scispherebeta2', password='scispherebeta2', database='scispherebeta2') 
    	  cursor = con.cursor()
	  ...
	  con.close()
       ...
       context = RequestContext(request)
       #return render_to_response("dc_madura_score.html", context_instance=context)
