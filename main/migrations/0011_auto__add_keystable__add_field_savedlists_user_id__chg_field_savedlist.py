...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeysTable'
        db.create_table('subscription_keys', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keys', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500L, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=2000L, null=True, blank=True)),
            ('formula', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
            ('source_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ...
            ('index_id', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
        ...
        db.send_create_signal('main', ['KeysTable'])
