	...
	if(contextualVariable){
		for(var i=0,j=0; i<contextualVariable.length; i+=3,j++){
			...
			if(( $.inArray(contextualVariable[i], selectedVariable) != -1)){
			    table+='<td id="'+contextualVariable[i]+'_selectedid" class="selected"><label class="popup-label" data-original-title="'+variable1+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+'  >'+source+'</a><br>'+
							'<strong>Units</strong> :<a style='+"'color:black'"+'  >'+variableUnit+'</a></div>'
			    ...
			    table+='<td id="'+contextualVariable[i]+'_selectedid"><label class="popup-label" data-original-title="'+variable1+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+'  >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+' >'+source+'</a><br>'+
			...
			if(( $.inArray(contextualVariable[i+1], selectedVariable) != -1)){
			     table+='<td id="'+contextualVariable[i+1]+'_selectedid" class="selected"><label class="popup-label" data-original-title="'+variable2+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+' >'+source+'</a><br>'+
			     ...
			     table+='<td id="'+contextualVariable[i+1]+'_selectedid"><label class="popup-label" data-original-title="'+variable2+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+' >'+source+'</a><br>'+
			...
			if(( $.inArray(contextualVariable[i+2], selectedVariable) != -1)){
				table+='<td id="'+contextualVariable[i+2]+'_selectedid" class="selected"><label class="popup-label"  data-original-title="'+variable3+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+' >'+source+'</a><br>'+
				...
				table+='<td id="'+contextualVariable[i+2]+'_selectedid"><label class="popup-label"  data-original-title="'+variable3+'" data-popover="true" data-html=true data-content="'
						+'<div>'+
							'<strong>Description</strong> :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'<strong>Formula</strong> :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'<strong>Source</strong> :<a style='+"'color:black'"+' >'+source+'</a><br>'+
			...
			if(name.length > 1){
				...
				if(fieldid == selectedVariable[i]){
					table+='<li class="selected" id="'+selectedVariable[i]+'"><a data-popover="true" data-html=true data-content="'
						+'<div>'+
							'Description :<a style='+"'color:black'"+' >'+Description+'</a><br>'+
							'Formula :<a style='+"'color:black'"+' >'+formula+'</a><br>'+
							'Source :<a style='+"'color:black'"+' >'+source+'</a><br>'+
							'Units :<a style='+"'color:black'"+' >'+variableUnit+'</a></div>'
